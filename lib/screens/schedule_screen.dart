      ...
      child: Column(
        ...
        children: [
          ...
          if (schedules.isEmpty)
            ...
            ...schedules.map(
              (s) => _scheduleCard(context, s, data, auth.userId),
            ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          IconButton(
            onPressed: () =>
                _showEditDialog(context, data, teacherId, schedule: s),
            ...
            child: Column(
              ...
              children: [
                DropdownButtonFormField<String>(
                  ...
                  onChanged: (v) =>
                      setDialogState(() => selectedDay = v ?? 'Monday'),
                ),
                ...
                ListTile(
                  ...
                  onTap: () async {
                    final picked = await showTimePicker(
                      context: context,
                      initialTime:
                          endTimeOfDay ?? const TimeOfDay(hour: 9, minute: 0),
                      builder: (context, child) {
                        return Theme(
                          data: Theme.of(context).copyWith(
                            colorScheme: const ColorScheme.dark(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                // Check for conflicts against ALL teachers' schedules
                final conflict = await data.checkScheduleConflictAsync(
                  selectedDay,
                  start24,
                  end24,
                  excludeId: isEdit
